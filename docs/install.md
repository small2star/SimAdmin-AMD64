...
本仓库（small2star/SimAdmin-AMD64）是 [3899/SimAdmin](https://github.com/3899/SimAdmin) 的 Fork，**专为 amd64（x86_64）架构编译**。所有安装脚本和 OTA 包均使用 amd64 二进制。

如需 ARM64 架构版本，请使用上游原版。
...
```bash
curl -fsSL https://raw.githubusercontent.com/small2star/SimAdmin-AMD64/main/install_latest.sh | sh
```

### 国内网络环境

```bash
curl -fsSL https://gh-proxy.com/https://raw.githubusercontent.com/small2star/SimAdmin-AMD64/main/install_latest.sh | sh
```

### 可选环境变量

```bash
curl -fsSL https://raw.githubusercontent.com/small2star/SimAdmin-AMD64/main/install_latest.sh \
  | REPO=small2star/SimAdmin-AMD64 INSTALL_DIR=/opt/simadmin SERVICE_NAME=simadmin sh
```

### 安装脚本动作说明

- 从 GitHub Release 下载 `simadmin-amd64.tar.gz`。
...
```bash
curl -fsSL https://raw.githubusercontent.com/small2star/SimAdmin-AMD64/main/uninstall.sh | sh
```

### 国内网络环境

```bash
curl -fsSL https://gh-proxy.com/https://raw.githubusercontent.com/small2star/SimAdmin-AMD64/main/uninstall.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/small2star/SimAdmin-AMD64/main/uninstall.sh \
  | sh -s -- --keep-user-data
```
